...
var BSSID_template = require(__dirname +  '/BSSID');
var STA_template = require(__dirname + "/STA");

var ieeeMAC = require(__dirname + '/ieeeMAC');
...
Sentinelle.prototype.sentinelle_capture = function sentinelle_capture() {
    ...
    that.pcap_session.on("packet", function (raw_packet) {
            ...
            var stationAddress = undefined;
            var bssidAddress = undefined;
            var bssid = undefined;
            var rssi = undefined;
                        ...
                        switch (packet.payload.ieee802_11Frame.subType) {
                            ...
                            case 0x0008:
                             /*   if (!packet.payload.ieee802_11Frame.flags.encrypted){
                                   //console.log(packet.payload.ieee802_11Frame);
                                }
                                /*
                                 if (packet.payload.ieee802_11Frame.flags.encrypted) {
